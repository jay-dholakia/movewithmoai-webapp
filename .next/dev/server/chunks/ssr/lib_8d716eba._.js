...
"[project]/lib/services/coachService.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class CoachService {
   ...
   */ static async getClients(coachId) {
        try {
            ...
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('coach_client_metrics').select('*').eq('coach_id', coachId).order('last_message_at', {
                ascending: false,
                nullsFirst: false
   ...
   */ static async getClientCommitmentHistory(userId, coachId) {
        ...
        if (coachId) {
            try {
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].rpc('get_coach_client_commitment_history', {
                    client_uuid: userId,
                    coach_uuid: coachId
                });
                if (!error && data) {
        ...
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('coach_client_commitment_history').select('*').eq('user_id', userId).order('week_start', {
            ascending: false
        });
        if (error) {
   ...
   */ static async getClientWorkoutHistory(userId, coachId, limit = 50) {
        ...
        if (coachId) {
            try {
                const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].rpc('get_coach_client_workout_history', {
                    client_uuid: userId,
                    coach_uuid: coachId,
                    result_limit: limit
                });
        ...
        // Fallback to direct query
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('coach_client_workout_history').select('*').eq('user_id', userId).order('date', {
            ascending: false
        }).order('started_at', {
            ascending: false
        }).limit(limit);
   ...
   */ static async getClientExercisePerformance(userId, exerciseName) {
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('coach_client_exercise_performance').select('*').eq('user_id', userId).order('workout_date', {
            ascending: false
        }).order('exercise_name', {
            ascending: true
        });
   ...
   */ static async getCoachProfile(coachId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('coaches').select('*').eq('id', coachId).single();
        if (error) {
   ...
   */ static async getCoachProfileByUserId(userId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('coaches').select('*').eq('user_id', userId).single();
        if (error) {
   ...
   */ static async getClientMetrics(userId, coachId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('coach_client_metrics').select('*').eq('user_id', userId).eq('coach_id', coachId).single();
        if (error) {
   ...
   */ static async getUserProfile(userId) {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('id, email, first_name, last_name, username, profile_picture_url, birthdate, gender, height_inches, weight_kg, experience_level, fitness_goal, equipment, injury_history, city, country, created_at').eq('id', userId).single();
        if (error) {
   ...
   */ static async getUserPlansHistory(userId) {
        try {
            ...
            const { data: userWorkouts, error: uwError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('user_workouts').select('id, workout_id, base_plan_id, created_at').eq('user_id', userId).order('created_at', {
                ascending: false
            });
            if (uwError) {
            ...
            // Get plan details
            const { data: plans, error: plansError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('workout_programs').select('plan_id, plan_name').in('plan_id', planIds);
            if (plansError) {
            ...
            // Get workout details
            const { data: workouts, error: workoutsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('workoutss').select('id, title, type').in('id', workoutIds);
            if (workoutsError) {
            ...
            const { data: completedSessions, error: sessionsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('workout_sessions').select('id, user_workout_id, completed_at, workout_template_id').eq('user_id', userId).eq('status', 'completed').not('completed_at', 'is', null);
            if (sessionsError) {
   ...
   */ static async getUserPersonalBests(userId) {
        try {
            ...
            const { data: sessions, error: sessionsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('workout_sessions').select('id, completed_at').eq('user_id', userId).eq('status', 'completed').not('completed_at', 'is', null);
            if (sessionsError) {
                console.error('Error fetching workout sessions:', sessionsError);
                return [];
            }
            ...
            const { data: exerciseSets, error: setsError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('exercise_sets').select('id, workout_session_id, exercise_name, weight_lbs, reps').in('workout_session_id', sessionIds).eq('is_completed', true);
            if (setsError) {
            ...
            const { data: exercises, error: exercisesError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('exercises').select('id, name').in('name', exerciseNames);
            if (exercisesError) {
...
//# sourceMappingURL=lib_8d716eba._.js.map