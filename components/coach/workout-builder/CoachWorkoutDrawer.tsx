...
export function AddWorkoutDrawer({
  ...
  const [hits, setHits] = useState<CoachWorkoutTemplateRow[]>([]);
  ...
  useEffect(() => {
    ...
    timer.current = setTimeout(async () => {
      ...
      const res = await CoachService.listWorkoutTemplates({
        // Show every workout a coach could pick from — their own plus the
        // shared library — excluding those already in this plan.
        pickable_for_plan: planId,
      ...
      if (res.success && Array.isArray(res.workouts)) {
        setHits(res.workouts as CoachWorkoutTemplateRow[]);
  ...
  const submit = async () => {
    ...
    const res =
      method === "new"
        ? await CoachService.createWorkoutTemplate({
            title: newTitle.trim(),
            type: newType,
            plan_id: planId,
            order_index: day,
          })
        : await CoachService.duplicateWorkoutTemplate({
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          ...
          {!method && (
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <MethodCard
                ...
                desc="Copy from your workouts or the shared library"
          ...
          {method === "duplicate" && (
            <div className="space-y-3">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {mine ? (
                              ...
                              <span
                                ...
                                title="From the shared library. You'll get your own editable copy."
                              >
              ...
              <p className="text-xs text-gray-500">
                Creates an independent copy in your library with all its
                exercises.
              </p>
            </div>
          )}
