...
export default function CoachLayout({
  ...
  const isClientsActive = pathname === '/coach' || 
    (pathname.startsWith('/coach/clients') && !pathname.startsWith('/coach/moais') && 
     !pathname.startsWith('/coach/community') && !pathname.startsWith('/coach/chat') && 
