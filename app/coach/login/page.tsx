  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute bottom-40 right-1/3 w-72 h-72 bg-blue-300 rounded-full opacity-25 blur-2xl animate-float-4"></div>
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-indigo-100 rounded-full opacity-20 blur-2xl animate-float-5"></div>
        <div className="absolute top-10 right-1/4 w-56 h-56 bg-slate-300 rounded-full opacity-25 blur-2xl animate-float-6"></div>
      </div>
