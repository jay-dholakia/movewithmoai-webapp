    ...
    <div className="relative">
      <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-4">
        {WEEKLY_RHYTHM_STEPS.map((item, i) => {
          ...
          return (
            <ScrollReveal key={item.title} delayMs={i * 80} className="h-full block">
              <div className="relative h-full rounded-xl border border-slate-200/90 bg-white p-4 shadow-sm">
                <span
                  className={cn(
      ...
      <ScrollReveal delayMs={340} className="mt-6 flex justify-center">
  ...
  return (
    <div className="marketing-landing min-h-screen overflow-x-hidden">
      ...
      <main id="main-content" className="scroll-smooth">
        {/* Hero */}
        <section
          className="relative isolate py-14 md:py-20 overflow-hidden border-b border-slate-300/40"
          aria-labelledby="hero-heading"
        >
          <video
            className="hero-bg-video pointer-events-none absolute inset-0 h-full w-full object-cover -z-20"
          ...
          <div className="max-w-2xl mx-auto px-6">
            <ScrollReveal>
              ...
              <div className="marketing-manifesto-body">
                <p>
                  A Moai is a small group of up to 10 people working toward their own
                  goals&mdash;and helping each other stay consistent along the way.
                </p>
                <p>
                  Most plans rely on willpower. But willpower fades. It&apos;s easier
                  to keep showing up when other people know your goals, notice your
                  progress, and expect to see you there.
                </p>
                <p>
                  That&apos;s what a Moai gives you: accountability, encouragement,
                  and people to keep going with.
                </p>
          ...
          <div className="max-w-5xl mx-auto px-6">
            <ScrollReveal>
              ...
              <p className="text-lg text-slate-600 max-w-2xl mb-8">
                Every week follows the same loop: set your commitment, show up, check
                in with your Moai, and celebrate when you hit it. Then it starts again.
              </p>
            </ScrollReveal>
            <WeeklyRhythm />
          </div>
